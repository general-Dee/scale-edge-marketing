          ...
          <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow">
            ...
            <div className="space-y-2">
              <label className="flex items-center p-3 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                />
                <span className="ml-3 text-sm sm:text-base text-gray-700 dark:text-gray-300">Standard (₦1,500) - 3-5 business days</span>
              </label>
              <label className="flex items-center p-3 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700">
                <input
                  type="radio"
                  ...
                  className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300"
                />
                <span className="ml-3 text-sm sm:text-base text-gray-700 dark:text-gray-300">Express (₦3,000) - 1-2 business days</span>
              </label>
            </div>
          </div>
        </div>
